...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    if(chainIdDec == "56") {
      this.setState({ account: accounts[0]}) 
      const SwapContract = new web3.eth.Contract(IndexSwap.abi, "0x0141fbC4Dab2CA603bE024f7239B6676b392A987");
      ...
      const SwapContract2 = new web3.eth.Contract(IndexSwap2.abi, "0x239433212bE7bAfF839874056cf58C2467aa528e");
  ...
  approveDeFiTokens = async() => {
    const web3 = new Web3(window.ethereum);  
    const contractAddress = "0x239433212bE7bAfF839874056cf58C2467aa528e";
  ...
  withdrawDeFiMainnet = async () => {
    ...
    await this.state.SwapContract.methods.approve("0x0141fbC4Dab2CA603bE024f7239B6676b392A987", "115792089237316195423570985008687907853269984665640564039457584007913129639935")
  ...
  withdrawDeFi = async () => {
    ...
    await this.state.SwapContract2.methods.approve("0x239433212bE7bAfF839874056cf58C2467aa528e", "115792089237316195423570985008687907853269984665640564039457584007913129639935")
    .send({from: this.state.account});
